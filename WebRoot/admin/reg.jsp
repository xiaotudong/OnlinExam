...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">在线考试系统&gt;&gt;用户注册</span>
</div>
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
          ...
          <td class="field">
            <input type="text" name="params.user_age" id="params.user_age" style="width:200px;"/>
            &nbsp;<label id="real_ageTip" style="color:red"></label>
          </td>
        </tr>  
        <tr>
          <td class="label">邮箱</td>
          <td class="field">
            <input type="text" name="params.user_mail" id="params.user_mail" value="22" style="width:100px;"/>
            &nbsp;<label id="user_mailTip" style="color:red"></label>
          </td>
        </tr> 
        <tr>
